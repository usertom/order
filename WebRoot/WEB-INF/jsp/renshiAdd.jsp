...
function isValid() {
	...
	function save() {
		...
		var mydata = '{"age":"'+ age + '","departmentId":"'+ 1 + '","salary":"'+ salary + '","address":"'+ address + '","name":"'+ name + '"}'; 
		$.ajax({
			type : 'post',
...
<table class="table2">
	<tr>
		<td>名字：</td>
		<td><input id="name" type="text"   maxLength="16"/></td>
	</tr>
	<tr>
		<td>年龄：</td>
		<td><input id="age" type="text"   maxLength="16"/></td>
	</tr>
	<tr>
		<td>地区：</td>
		<td><input id="address" type="text"  maxLength="16"/></td>
	</tr>
	<tr>
		<td>工资：</td>
		<td><input id="salary" type="text"  maxLength="16"/></td>
	</tr>
	<tr>
