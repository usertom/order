...
<head>
	...
	function loadList(){
		...
		$('#dataTable').datagrid({ 
			...
			showHeader : true,
			showFooter : true,
		    url:'/order/renshi/renshiList.do', 
		    columns : [[ {
				...
				field : 'salary',
				title : '<strong>工资</strong>',halign : 'center',align : 'center',sortable : true,width : 80
			},{
				field : 'operate',
	...
	function update(id) {
		var url = '/order/renshi/update.do';
		var param = '?id=' + id;
		$('#editDiv').dialog({
			title : '修改',
			href : url + param,
	...
	function exportExcel(){
		...
		$.ajax({
		type : 'post',
		url : '/order/renshi/exportExcel.do',
		data : {
		taskIds:idsString
		},
		dataType : 'json',
	...
	<table  class="table2" style="border-bottom: 1px solid #ccc">
		<tr height="39px">
			<td style="padding-left: 10px;">
				...
				<a id="add" href="#" class="easyui-linkbutton"  style="margin-right: 10px" onclick="add()">新增人员</a>
				<a id="export" href="#" class="easyui-linkbutton"  style="margin-right: 10px" onclick="exportExcel()">导出Excel</a>
 			</td>
		</tr>
	</table>
	</form>
</div>
<div data-options="region:'center',title:'人事部管理',split:true">
