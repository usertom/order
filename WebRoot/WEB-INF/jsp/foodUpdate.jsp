...
function isValid() {
	...
	function save() {
		...
		var mydata = '{"name":"'+ name + '","id":"'+ id + '","cost":"'+ cost + '","day":"'+ day + '","content":"'+ content + '"}'; 
		$.ajax({
			type : 'post',
...
<table class="table2">
	<tr>
		<td>菜式：</td>
		<td><input id="name" value="${food.name }" type="text"   /></td>
	</tr>
	<tr>
		<td>内容：</td>
		<td><input id="content"  value="${food.content }" type="text"  /></td>
	</tr>
	<tr>
		<td>价钱：</td>
		<td><input id="cost" type="text" value="${food.cost }" /></td>
	</tr>
	<tr>
		<td>星期：</td>
		<td><input id="day" type="text" value="${food.day }" /></td>
	</tr>
	<tr>
